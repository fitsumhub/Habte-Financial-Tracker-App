...
object Data {
    ...
    val PRESET_BANKS = listOf(
        Bank("cbe",     "Commercial Bank of Ethiopia", "CBE",  listOf(), "#3730A3", "#1E1B4B", "CBE"),
        Bank("boa",     "Bank of Abyssinia",          "BOA",  listOf(), "#F59E0B", "#B45309", "BOA"),
        Bank("awash",   "Awash Bank",                 "AWA",  listOf(), "#1E40AF", "#1D4ED8", "AWB"),
        Bank("dashen",  "Dashen Bank",                "DAS",  listOf(), "#1E3A8A", "#EF4444", "DSB"),
        Bank("hibret",  "Hibret Bank",                "HIB",  listOf(), "#059669", "#D97706", "HBT"),
        Bank("zemen",   "Zemen Bank",                 "ZEM",  listOf(), "#111827", "#D97706", "ZMN"),
        Bank("nib",     "Nib International Bank",     "NIB",  listOf(), "#1E40AF", "#FACC15", "NIB"),
        Bank("coop",    "Cooperative Bank of Oromia", "COO",  listOf(), "#047857", "#F59E0B", "CPB"),
        Bank("abay",    "Abay Bank",                  "ABY",  listOf(), "#1D4ED8", "#059669", "ABY"),
        Bank("berhan",  "Berhan Bank",                "BER",  listOf(), "#B91C1C", "#F59E0B", "BRH"),
        Bank("bunna",   "Bunna Bank",                 "BUN",  listOf(), "#451A03", "#D97706", "BNA"),
        Bank("wegagen", "Wegagen Bank",               "WEG",  listOf(), "#1D4ED8", "#F59E0B", "WGN"),
        Bank("oromia",  "Oromia Bank",                "ORO",  listOf(), "#059669", "#B91C1C", "ORB"),
        Bank("lion",    "Lion Bank",                  "LIO",  listOf(), "#F59E0B", "#B91C1C", "LIB"),
        Bank("enat",    "Enat Bank",                  "ENA",  listOf(), "#DB2777", "#1D4ED8", "ENB"),
